      ...
      var f = function (t) {
        ...
        e("[data-scroll-nav]").removeClass(n.activeClass);
          ...
          e(window).on("beforeunload", function () {
              e(window).off("scroll", l);  // Unbind scroll listener
              e(window).off("keydown", a);  // Unbind keydown listener
              e("body").off("click", "[data-scroll-nav], [data-scroll-goto]");  // Unbind click listener
          });
      };
      var l = function () {
